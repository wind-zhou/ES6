...
Generator 函数是 ES6 提供的**一种异步编程解决方案**，语法行为与传统函数完全不同。本章详细介绍 Generator 函数的语法和 API，它的异步编3程应用请看《Generator 函数的异步应用》一章。
...
>**常用场景，几个ajax异步操作请求数据，前一个请求的数据作下一个ajax请求的参数。**
...
![mark](http://qiniu.wind-zhou.com/blog/210402/74FkjIKmhf.png?imageslim)
